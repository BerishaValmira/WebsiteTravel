    ...
    <table border="2" class="table1">
        ...
        foreach($hotels as $hotel){
           ...
           <tr>
               <td>$hotel[HotID]</td>
               <td>$hotel[HotName]</td>
               <td>$hotel[HotLocation]</td>
               <td>$hotel[HotImage]</td>
               <td>$hotel[HotCapacity]</td>
               ...
               <a href='edithotel.php?ID=$hotel[HotID]'>Edit</a>
             </button>
               </div>
               </td>
               <td>
               ...
               <button  class='button1' style='width: 100%; height: 100%;'>
               <a href='delhotel.php?ID=$hotel[HotID]'>Delete</a>
             </button>
           </tr>
