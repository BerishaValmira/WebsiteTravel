...
<input type="number" name="HotID" value="" placeholder="Hotel_ID"><br><br>
<input type="text" name="Name" value="" placeholder="Name"><br><br>
<input type="text" name="Location" value=""  placeholder="Location"><br><br>
<input type="text" name="Image" value="" placeholder="Image"><br><br>
<input type="text" name="Capacity" value="" placeholder="Capacity"><br><br>
